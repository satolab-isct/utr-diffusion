...
def sample_continuous_single_label_condition_weight_sweep():
    unet = UNet_CL(
        dim=200,  # 200
        channels=1,
    ...
    cond_weights = [1, 2, 3, 4, 5, 10, 20, 50, 100]
    for cond_weight in cond_weights:
        ...
        model_save_name = "save/MFE_967k_ep_2k_ts_200_beta_0.01_cond_1_uncond_0.2_drop_0.2_lr_1e-4_at_2000epoch_sample_sweep_cond_sweep"
        checkpoint_path = "checkpoints/MFE_967k_ep_2k_ts_200_beta_0.01_cond_1_uncond_0.2_drop_0.2_lr_1e-4_at_2000epoch.pt"
        model_save_name = os.path.join(ROOT, model_save_name, f'cond_{cond_weight}')
...
if __name__ == "__main__":
    sample_continuous_single_label_condition_weight_sweep()